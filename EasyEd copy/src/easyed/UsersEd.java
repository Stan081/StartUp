...
public class UsersEd {
    ...
    public UsersEd(String firstName, String lastName, String email, String phoneNumber, String userName, String password, String sex, String role, String secretWord) {
    ...
    public UsersEd(String userName, String password, String role) {
        this.userName = userName;
        this.password = password;
        this.role = role;
    }

    public UsersEd(String userName, String password) {
        this.userName = userName;
        this.password = password;
    }
